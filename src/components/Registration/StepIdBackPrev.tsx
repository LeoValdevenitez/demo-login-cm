...
interface StepIdBackPrevProps {
  onNext: () => void;
  onBack: () => void;
}

const StepIdBackPrev: React.FC<StepIdBackPrevProps> = ({ onNext, onBack }) => {
  const { registrationData } = useUserAuth();

  return (
    <div className="flex flex-col flex-1 items-center justify-between">
      <div className="text-center mb-4">
        <h2 className="text-xl font-bold text-gray-800 mb-2">Confirma el dorso de tu documento</h2>
